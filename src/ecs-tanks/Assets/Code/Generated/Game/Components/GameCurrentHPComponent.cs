...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.LifetimeProcessing.CurrentHP currentHP { get { return (Assets.Code.Gameplay.Features.LifetimeProcessing.CurrentHP)GetComponent(GameComponentsLookup.CurrentHP); } }
    ...
    public GameEntity AddCurrentHP(float newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.LifetimeProcessing.CurrentHP)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.LifetimeProcessing.CurrentHP));
