...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.LifetimeProcessing.MaxHP maxHP { get { return (Assets.Code.Gameplay.Features.LifetimeProcessing.MaxHP)GetComponent(GameComponentsLookup.MaxHP); } }
    ...
    public GameEntity AddMaxHP(float newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.LifetimeProcessing.MaxHP)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.LifetimeProcessing.MaxHP));
