...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Shooting.TargetLimit targetLimit { get { return (Assets.Code.Gameplay.Features.Shooting.TargetLimit)GetComponent(GameComponentsLookup.TargetLimit); } }
    ...
    public GameEntity AddTargetLimit(int newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Shooting.TargetLimit)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Shooting.TargetLimit));
