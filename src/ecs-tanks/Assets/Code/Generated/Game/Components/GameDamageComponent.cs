...
public partial class GameEntity {
    ...
    public Assets.Code.Gameplay.Features.Shooting.Damage damage { get { return (Assets.Code.Gameplay.Features.Shooting.Damage)GetComponent(GameComponentsLookup.Damage); } }
    ...
    public GameEntity AddDamage(float newValue) {
        ...
        var component = (Assets.Code.Gameplay.Features.Shooting.Damage)CreateComponent(index, typeof(Assets.Code.Gameplay.Features.Shooting.Damage));
